    ...
    <footer className="mt-[60px] border-t-2 border-primary text-wrap">
      <Container top="pt-[50px]">
        <div className="flex flex-col justify-between gap-12 lg:flex-row lg:gap-0">
          ...
          >
            <img src="/assets/nata-purple 2.svg" alt="syrsdev" width={56} />
            <h5 className="font-bold text-[24px] ">Syrsdev Portfolio</h5>
            <p>
          ...
          >
            <div className="flex flex-col gap-[15px]">
              <h6 className="font-bold text-[20px] ">Contact Info</h6>
            ...
            <div className="flex flex-col gap-[15px]">
              ...
              <ul className="flex flex-col gap-[15px]" id="scroll3">
                <li>
                ...
                <li>
                  <Link className="hover:text-primary" to={"/contacts"}>
                    Contacts
                  </Link>
                </li>
              </ul>
