      ...
      <Layout>
          ...
          <header className="flex flex-col md:items-center md:flex-row">
            ...
            >
              ...
              <div className="flex flex-col w-full gap-5 mt-8 md:gap-3 lg:gap-5 md:w-max md:flex-row">
                ...
                <Button href={cv} download={"cv-surya nata ardhana.pdf"}>
                  Download Resume
                </Button>
              </div>
            </div>
            ...
            <section>
              ...
              >
                {skill.length != 0 ? (
                  ...
                  <div data-aos="zoom-in" className="w-1/2 md:w-1/3">
                    <img src="./assets/not-found.svg" className="w-full" />
                  </div>
                )}
              </div>
        ...
        <Container top="pt-[100px]">
          <div className="relative">
            <div className="absolute -inset-1  bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-neutral-600 via-[#7D43E8] to-stone-600 opacity-50 blur-xl"></div>
            <div
              data-aos="zoom-in"
              className="relative flex flex-col md:flex-row bg-secondary rounded-[30px] px-[20px] md:px-[50px] xl:px-[75px] py-[25px] gap-14 md:gap-[100px] justify-between"
            >
