  ...
  return (
    <Layout>
      <Container top="pt-[160px] md:pt-[180px]">
        <div className="flex flex-col w-full mb-[230px]" data-aos="zoom-in">
          ...
          <div className="w-full md:rounded-[0_28px_28px_28px] rounded-[0_0_28px_28px] bg-secondary py-12  px-6 md:px-12 xl:px-24">
            {tab == false ? (
              <>
                <div className="mb-10">
                  <Title mb="mb-3" text="start" title="About Me" />
                  {about.length == 0 ? (
                    <AboutSkeleton />
                  ) : about?.about != null ? (
                    <div
              ...
              <div className="flex flex-col justify-between gap-10 md:flex-col-reverse lg:flex-row">
                <div className="w-full lg:w-fit">
                  <Title title="Education" mb="mb-5" text="start" />
                  {about.length == 0 ? (
                    <ExperienceSkeleton />
                      ...
                      {about.education.map((item) => (
                        <li className="px-5" key={item.id}>
                          ...
                          <div className="flex flex-col gap-1">
                            ...
                            <p className="text-[12px]">{item.major}</p>
                          </div>
                        </li>
                      ))}
                    </ol>
